...
import { LogOut, Settings, TrendingUp, ChevronDown, Moon, Sun } from 'lucide-react'
import { useTheme } from './ThemeProvider'
import Link from 'next/link'

interface NavigationProps {
  user: User
  currentPage: 'dashboard' | 'portfolios' | 'ai-investor' | 'stocks'
}
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-6">
            ...
            <nav className="hidden md:flex gap-4">
              ...
              <div className="relative">
                ...
                {resourcesOpen && (
                  <>
                    ...
                    />
                    <div className="absolute top-full left-0 mt-2 w-56 bg-white dark:bg-gray-800 rounded-lg shadow-lg border border-gray-200 dark:border-gray-700 py-2 z-20">
                      <Link
                        href="/stocks"
              ...
              <Link
                href="/ai-investor"
                className={currentPage === 'ai-investor' ? 'text-primary-600 font-semibold' : 'text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white'}
              >
                AI Investor
              </Link>
            </nav>
